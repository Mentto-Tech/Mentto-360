...
export default function Footer() {
    return (
        <footer className="bg-white dark:bg-black text-subtext-light dark:text-subtext-dark pt-16 pb-8 px-6">
            <div className="container mx-auto">
                <div className="flex flex-col md:flex-row justify-between gap-8">
                    <div className="max-w-md">
                        <Image
                            alt="Mentto logo"
                            className="h-12 mb-4 dark:invert w-auto"
                        ...
                        <div className="flex space-x-4 mt-6">
                            <Link className="text-subtext-light dark:text-subtext-dark hover:text-text-light dark:hover:text-text-dark" href="https://www.instagram.com/menttotech/">
                            ...
                            <Link className="text-subtext-light dark:text-subtext-dark hover:text-text-light dark:hover:text-text-dark" href="https://www.linkedin.com/company/mentto/">
                                <svg aria-hidden="true" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="md:text-right">
                        <h5 className="font-bold text-text-light dark:text-text-dark mb-4">QG da Mentto</h5>
                ...
                <div className="border-t border-gray-300 dark:border-gray-600 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center text-xs">
                    <div className="flex space-x-4 mb-4 md:mb-0">
                        <Link className="hover:text-text-light dark:hover:text-text-dark" href="/termos">Termos de Uso e Políticas de Privacidade</Link>
                    </div>
                    ...
                    <div>
                        <p>Design feito por: <span className="font-bold text-text-light dark:text-text-dark">Mentto</span></p>
                    </div>
                </div>
            </div>
        </footer>
