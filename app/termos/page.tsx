    ...
    return (
        <div className="min-h-screen flex flex-col bg-background-light">
            ...
            <main className="flex-grow container mx-auto px-4 py-12 md:py-20 max-w-4xl">
                <div className="bg-surface-light rounded-2xl shadow-xl p-8 md:p-12 border border-gray-100">
                    ...
                    <div className="space-y-8 text-text-light leading-relaxed">
                        ...
                        <section className="bg-white p-6 rounded-lg border-l-4 border-primary shadow-sm">
                        ...
                        <section>
                            <h2 className="text-xl md:text-2xl font-bold mb-4 text-text-light">1. Objeto</h2>
                        ...
                        <section>
                            <h2 className="text-xl md:text-2xl font-bold mb-4 text-text-light">2. Sobre a Mentoria</h2>
                            <p className="mb-4 text-subtext-light">
                                A Mentoria Impacto360 é um programa gratuito para empresas selecionadas pelo PLAN360, com 20 horas de encontros, incluindo:
                            </p>
                            <ul className="list-disc pl-6 space-y-2 marker:text-primary text-subtext-light">
                        ...
                        <section>
                            <h2 className="text-xl md:text-2xl font-bold mb-4 text-text-light">3. Condições da Reserva</h2>
                            <p className="mb-4 text-subtext-light">Ao firmar este Termo de Reserva, a empresa:</p>
                            <ol className="list-decimal pl-6 space-y-3 marker:font-bold marker:text-text-light text-subtext-light">
                                ...
                                <li>
                                    ...
                                    <ul className="list-disc pl-6 mt-2 space-y-1 marker:text-subtext-light">
                        ...
                        <section>
                            <h2 className="text-xl md:text-2xl font-bold mb-4 text-text-light">4. Gratuidade</h2>
                            <p className="text-subtext-light">
                        ...
                        <section>
                            <h2 className="text-xl md:text-2xl font-bold mb-4 text-text-light">5. Compromissos da Empresa</h2>
                            <p className="mb-4 text-subtext-light">A empresa participante compromete-se a:</p>
                            <ul className="list-disc pl-6 space-y-2 marker:text-primary text-subtext-light">
                        ...
                        <section>
                            <h2 className="text-xl md:text-2xl font-bold mb-4 text-text-light">6. Compromissos da Realização</h2>
                            <p className="mb-4 text-subtext-light">A ASSERTI/PLAN360 compromete-se a:</p>
                            <ul className="list-disc pl-6 space-y-2 marker:text-primary text-subtext-light">
                        ...
                        <section>
                            <h2 className="text-xl md:text-2xl font-bold mb-4 text-text-light">7. Vigência</h2>
                            <p className="text-subtext-light">
